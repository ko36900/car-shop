...
public class Category implements Serializable {
    ...
    private Collection<Autoparts> autopartsCollection;
    ...
    @XmlTransient
    public Collection<Autoparts> getAutopartsCollection() {
        return autopartsCollection;
    }

    public void setAutopartsCollection(Collection<Autoparts> autopartsCollection) {
        this.autopartsCollection = autopartsCollection;
    }
